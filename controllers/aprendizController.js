...
exports.getDashboard = async (req, res) => {
  ...
  // Determinar módulos bloqueados (lineal: necesita 100% del anterior y que esté desbloqueado)
...
exports.postEntregar = async (req, res) => {
...
// ── COMPLETAR JUEGO ───────────────────────────────────────────────────────────
exports.postCompletarJuego = async (req, res) => {
...
// ── ENTREGAR EVALUACIÓN ───────────────────────────────────────────────────────
exports.postEntregarEval = async (req, res) => {
