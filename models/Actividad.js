...
const actividadSchema = new mongoose.Schema({
  ...
  tipo: { type: String, enum: ['blog', 'juego', 'evaluacion'], required: true },
  ...
  tipoEntrega: { type: String, enum: ['texto', 'archivo', null], default: null },
  ...
  tipoJuego: {
    type: String,
    enum: ['juego_emparejar', 'juego_ahorcado_salud', 'juego_sopa_letras', null],
    default: null
  },
